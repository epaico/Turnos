...
namespace Turnos.Controllers
{
    public class MedicoController : Controller
    {
        ...
        {
            ViewData["ListaEspecialidades"] = new SelectList(_context.Especialidad, "IdEspecialidad", "Description");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ListaEspecialidades"] = new SelectList(
                _context.Especialidad, "IdEspecialidad", "Description", medico.MedicoEspecialidad[0].IdEspecialidad);
